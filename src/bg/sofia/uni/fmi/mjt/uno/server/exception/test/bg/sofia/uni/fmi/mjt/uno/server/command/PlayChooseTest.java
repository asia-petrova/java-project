...
public class PlayChooseTest {
    ...
    void testExecute() throws Exception {
        ...
        verify(manager, times(2)).getGame(player);
        verify(game, atLeastOnce()).executePlayersCard(1, player);
        verify(game, atLeastOnce()).setCurrentColor(Color.RED);
    }
